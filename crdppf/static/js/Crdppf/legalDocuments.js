...
*/
   ...
   // configure whether filter query is encoded or not (initially)
    ...
    var myPageSize = 25;  // server script should only send back 10 items at a time
        
	// definition du datastore
	var legaldocs=new Ext.data.Store({
        autoDestroy: true,
        autoLoad: true,
		proxy:proxy,
        remoteSort: true,
        baseParams: {
            filters: Ext.encode(Crdppf.docfilters)
        },
        sorters: [{
            property: 'documentid',
            direction: 'ASC'
